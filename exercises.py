...
def manage_students():
    students = ['Ali', 'Jojo', 'Momo', 'Fofo', 'Koko', 'Lolo', 'Abu Jojo']
...
def combine_foods():
    foods = ('neapolitan', 'Spaghetti', 'Carbonara', 'Confetti', 'Ravioli', 'Lasagna', 'focaccia')
    meal = ''
...
def filter_foods_with_a():
    ...
    # first food (to what to include in the list), second food in foods (looping), third is condition.
